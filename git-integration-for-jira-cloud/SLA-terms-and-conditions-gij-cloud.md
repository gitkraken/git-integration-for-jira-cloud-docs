...
Contact us via [Support](https://help.gitkraken.com/git-integration-for-jira-cloud/gij-cloud-contact-support/).

**On this page:**
- [Support coverage and commitments](#support-coverage-and-commitments)
- [Scope of technical support](#scope-of-technical-support)
- [Support exceptions and limitations](#support-exceptions-and-limitations)
- [Platform compatibility and customer responsibilities](#platform-compatibility-and-customer-responsibilities)
...
<div class="bbb-callout bbb--info">
    ...
    <div class="imsgbox">
        SLA commitments apply exclusively to <b>paid Git Integration for Jira licenses</b> with <b>current and active License Maintenance coverage</b>.
    </div>
    </div>
</div>

For details on supported Jira versions, browser compatibility, service limitations, and end-of-life policies, see [Support & Compatibility Information](https://help.gitkraken.com).
...
GitKraken follows [Atlassian's official End of Life (EOL) policies](https://confluence.atlassian.com/support/atlassian-support-end-of-life-policy-201851003.html) and expects customers to maintain compatible environments.
...
See the [Atlassian Marketplace Versions Page](https://marketplace.atlassian.com/apps/4984/git-integration-for-jira/version-history) for version compatibility details.
