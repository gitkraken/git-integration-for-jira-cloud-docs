...
The Git Roll Up Issue tab displays a summary of the files, lines, and developers who made changes in the commits associated with the Jira issue.
...
- [Deep Linking into GitLens](/git-integration-for-jira-cloud/Deeplinking-feature-gij-cloud)
