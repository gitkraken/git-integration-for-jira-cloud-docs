...
The Git Commits Project Page lists the git commits associated with the Jira project, grouped by repository and sorted by commit time.
...
The View Full Commit button opens a screen that details the source code change in the commit.
...
The Change association feature allows you to update the Jira issues associated with a commit.
